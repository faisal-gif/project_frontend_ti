                        ...
                        <main className="col-span-1" >
                           <article className="rounded-lg md:overflow-hidden">
                                ...
                                <div className="flex flex-col gap-2 border-b border-base-content/20 pb-4 text-sm text-muted-foreground">
                                    ...
                                    {
                                        (newsDetail.catnews_slug === 'kopi-times' || newsDetail.catnews_slug === 'kopi-times-forum-guru' || newsDetail.catnews_slug === 'kopi-times-forum-mahasiswa' || newsDetail.catnews_slug === 'kopi-times-forum-dosen') && (
                                            writerKopiTimes && (
