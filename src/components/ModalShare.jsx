    ...
    <dialog id="modal_share" className="modal modal-bottom sm:modal-middle">
      <div className="modal-box sm:w-full sm:max-w-lg">
        ...
        <div className="grid grid-cols-3 gap-4 py-4">
          ...
          <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(shareText)}`} target="_blank" rel="noopener noreferrer" className="btn btn-outline text-neutral"> <Image src={logo_x_black} alt="Logo X" width={24} height={24} /> </a>
          ...
          <a href={`https://api.whatsapp.com/send?text=${encodeURIComponent(shareText)}`} target="_blank" rel="noopener noreferrer" className="btn btn-outline text-green-500"> <Image src={logo_whatsapp} alt="Logo WhatsApp" width={24} height={24} /> </a>
          <a href={`https://t.me/share/url?url=${encodeURIComponent(url)}&text=${encodeURIComponent(shareText)}`} target="_blank" rel="noopener noreferrer" className="btn btn-outline text-blue-400"> <Image src={logo_telegram} alt="Logo Telegram" width={24} height={24} /> </a>
