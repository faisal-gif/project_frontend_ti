const HeadlineCardSkeleton = () => {
    return (
        <div className="relative h-60 w-full cursor-pointer overflow-hidden rounded-lg border-0 shadow-lg transition-all duration-300 hover:shadow-2xl lg:h-[28rem]">
