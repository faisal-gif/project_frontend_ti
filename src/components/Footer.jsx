      ...
      <div className="container max-w-6xl mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 items-center justify-center text-xs md:text-sm">
            ...
            <Link href="/page/jurnalisme-positif" className="text-white/65 hover:text-[#b51d1d] transition-colors">Jurnalisme Positif</Link>
            <Link href="/page/kode-etik-jurnalis-times-indonesia" className="text-white/65 hover:text-[#b51d1d] transition-colors">Kode Etik Jurnalis</Link>
          </div>
