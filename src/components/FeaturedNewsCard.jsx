...
function FeaturedNewsCard({
    ...
    return (
        <Card className={`group relative h-60 w-full cursor-pointer overflow-hidden rounded-lg border-0 shadow-lg transition-all duration-300 hover:shadow-2xl md:h-[28rem] ${className}`}>
            <div
